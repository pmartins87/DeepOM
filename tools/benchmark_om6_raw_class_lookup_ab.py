...
def run_variant(
    *,
    ...
    solver = DenseExternalSamplingCFR(
        ...
        fast_class_lookup=fast_class_lookup,
    )
...
def main() -> None:
    ...
    result = {
        ...
        "raw_lookup_bytes": int(index.raw_to_class.nbytes),
    ...
    if not result["exact_trajectory_match"]:
        raise SystemExit("raw class lookup changed the CFR trajectory")
    print("OM6_RAW_CLASS_LOOKUP_AB=PASS")
